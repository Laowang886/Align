...
export const workspaceApi = {
  ...
  get: (workspaceId: string) => apiRequest<WorkspaceDetails>(`/workspaces/${workspaceId}`),
  ...
  inviteMember: (workspaceId: string, input: { email: string; role: Exclude<WorkspaceRole, "OWNER"> }) =>
  ...
  updateMemberRole: (workspaceId: string, memberId: string, role: Exclude<WorkspaceRole, "OWNER">) =>
    apiRequest<WorkspaceMember>(`/workspaces/${workspaceId}/members/${memberId}`, {
      method: "PATCH",
      body: JSON.stringify({ role }),
    }),
  removeMember: (workspaceId: string, memberId: string) =>
    apiRequest<void>(`/workspaces/${workspaceId}/members/${memberId}`, { method: "DELETE" }),
